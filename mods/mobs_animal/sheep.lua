...
for _, col in pairs(rainbow.colours) do
	...
	mobs:register_mob("mobs_animal:sheep_"..col[1], {
		...
		drops = {
			...
			{name = "rainbow:wool_"..col[1], chance = 1, min = 1, max = 1},
		},
		water_damage = 1,
		lava_damage = 5,
		light_damage = 0,
		...
		on_rightclick = function(self, clicker)
			...
			if itemname == "mobs:shears" then
				...
				local obj = minetest.add_item(
					self.object:getpos(),
					ItemStack( "rainbow:wool_" .. col[1] .. " " .. math.random(1, 3) )
				)
			...
			if itemname:find("dye") then
				...
				and name == self.owner then
					...
					local colr = string.split(itemname, "_")[2]

					for _,c in pairs(rainbow.colours) do
	...
	mobs:register_egg("mobs_animal:sheep_"..col[1], col[2] .. " " .. S("Sheep"), "plain_wool.png^[colorize:"..col[3], 1)
    ...
    mobs:spawn({
        name = "mobs_animal:sheep_"..col[1],
        nodes = {"rainbow:dirt_"..col[1]},
        min_light = 10,
        chance = 15000,
        min_height = 0,
        max_height = 31000,
